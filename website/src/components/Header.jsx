...
export default function Header() {
  ...
  // Nav anchors only exist on the home page, so link back to it with the
  // hash rather than a same-page "#features" that would do nothing here.
    ...
    <header className="sticky top-0 z-30 border-b border-stone-800/80 bg-stone-950/85 backdrop-blur-sm">
      <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
        <a href={home} className="flex items-center gap-2.5">
          ...
          <span className="font-semibold tracking-tight">Capcove</span>
        </a>
        ...
        <div className="flex items-center gap-3">
          <LanguageSwitcher />
          <a
            href="https://github.com/xacnio/capcove"
            target="_blank"
            rel="noreferrer"
