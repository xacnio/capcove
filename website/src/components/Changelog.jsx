...
export default function Changelog({ releases }) {
  ...
  return (
    <section id="changelog" className="max-w-6xl mx-auto px-6 py-24 border-t border-stone-800/80">
      <h2 className="text-3xl font-bold tracking-tight">{t("changelog.title")}</h2>
